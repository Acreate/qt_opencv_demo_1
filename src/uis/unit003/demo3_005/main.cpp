...
int main( int argc, char *argv[] ) {
	...
	// 获取输入
	cv::Mat image = cvFunction::readImage("waves.jpg");
	if ( !image.data )
		return 0;
	...
	// Load color image
	ColorHistogram hc;
	cv::Mat color = cvFunction::readImage("waves.jpg");
	...
	// Second color image
	cv::Mat color2 = cvFunction::readImage("dog.jpg");
	...
	// Second colour image
	color2 = cvFunction::readImage("dog.jpg");
