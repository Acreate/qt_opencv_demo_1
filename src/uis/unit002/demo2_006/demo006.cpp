...
void unit002::demo002_006::salt( cv::Mat image, int n ) {
...
void unit002::demo002_006::colorReduce( const cv::Mat &image, cv::Mat &result, int div ) {
...
void unit002::demo002_006::sharpen( const cv::Mat &image, cv::Mat &result ) {
	result.create(image.rows, image.cols, image.type());
...
void unit002::demo002_006::sharpen2D( const cv::Mat &image, cv::Mat &result ) {
	// 构建内核
